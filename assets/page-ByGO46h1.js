import{r as f,R as O,G as $e,j as a,d as h,Y as pe,c as Ie,b as Re,C as Ee,B as k,M as Ne,T as Oe,I as Le,S as ke}from"./index-4Zad1DyB.js";import{u as _e,a as Me}from"./mock-DkxYh4ZF.js";import{g as Fe,c as De}from"./utils-BQf6Ipkh.js";import Ge from"./notfound-DXYiPC4G.js";var z={exports:{}},K,se;function Ae(){if(se)return K;se=1;var e="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return K=e,K}var B,re;function Ue(){if(re)return B;re=1;var e=Ae();function s(){}function t(){}return t.resetWarningCache=s,B=function(){function n(c,p,y,u,x,w){if(w!==e){var C=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw C.name="Invariant Violation",C}}n.isRequired=n;function l(){return n}var o={array:n,bigint:n,bool:n,func:n,number:n,object:n,string:n,symbol:n,any:n,arrayOf:l,element:n,elementType:n,instanceOf:l,node:n,objectOf:l,oneOf:l,oneOfType:l,shape:l,exact:l,checkPropTypes:t,resetWarningCache:s};return o.PropTypes=o,o},B}var oe;function We(){return oe||(oe=1,z.exports=Ue()()),z.exports}var be=We();function V(e){return s=>!!s.type&&s.type.tabsRole===e}const L=V("Tab"),D=V("TabList"),G=V("TabPanel");function qe(e){return L(e)||D(e)||G(e)}function Y(e,s){return f.Children.map(e,t=>t===null?null:qe(t)?s(t):t.props&&t.props.children&&typeof t.props.children=="object"?f.cloneElement(t,Object.assign({},t.props,{children:Y(t.props.children,s)})):t)}function M(e,s){return f.Children.forEach(e,t=>{t!==null&&(L(t)||G(t)?s(t):t.props&&t.props.children&&typeof t.props.children=="object"&&(D(t)&&s(t),M(t.props.children,s)))})}function he(e,s,t){let n,l=0,o=0,c=!1;const p=[],y=e[s];return M(y,u=>{D(u)&&(u.props&&u.props.children&&typeof u.props.children=="object"&&M(u.props.children,x=>p.push(x)),c&&(n=new Error("Found multiple 'TabList' components inside 'Tabs'. Only one is allowed.")),c=!0),L(u)?((!c||p.indexOf(u)===-1)&&(n=new Error("Found a 'Tab' component outside of the 'TabList' component. 'Tab' components have to be inside the 'TabList' component.")),l++):G(u)&&o++}),!n&&l!==o&&(n=new Error(`There should be an equal number of 'Tab' and 'TabPanel' in \`${t}\`. Received ${l} 'Tab' and ${o} 'TabPanel'.`)),n}function ze(e,s,t,n,l){const o=e[s],c=l||s;let p=null;return o&&typeof o!="function"?p=new Error(`Invalid ${n} \`${c}\` of type \`${typeof o}\` supplied to \`${t}\`, expected \`function\`.`):e.selectedIndex!=null&&o==null&&(p=new Error(`The ${n} \`${c}\` is marked as required in \`${t}\`, but its value is \`undefined\` or \`null\`.
