...
`,o=e.a`
  font-size: 16px;
  color: ${a=>a.theme.secondary};
  text-decoration: none;
  &:hover {
    color: ${a=>a.theme.primary};
  }
`,k=()=>{const a=l(),{themeName:h}=d(s=>s.theme),c=()=>{a(g())},n=()=>{a(p())};return t.jsxs(j,{children:[t.jsxs(v,{children:[t.jsx(M,{src:u,alt:"Logo"}),t.jsx(Z,{children:"Lorem"})]}),t.jsxs(L,{children:[t.jsx(o,{href:"#features",children:"功能介紹"}),t.jsx(o,{href:"#pricing",children:"價格方案"}),t.jsx(o,{href:"#contact",children:"聯絡我們"}),t.jsx(r,{onClick:c,children:"QrCode"}),t.jsx(r,{onClick:n,children:h==="light"?t.jsx(m,{}):t.jsx(f,{})})]})]})},C=e.div`
  height: 100vh;
  background-color: ${a=>a.theme.background};
  color: ${a=>a.theme.color};
`,A=()=>t.jsxs(C,{children:[t.jsx(k,{}),t.jsx(x,{})]});export{A as default};
