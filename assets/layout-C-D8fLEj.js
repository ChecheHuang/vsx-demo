...
`,o=e.a`
  ...
  ${h()}
`,y=()=>{const a=d(),{themeName:n}=g(l=>l.theme),s=()=>{a(p())},c=()=>{a(x())};return t.jsxs(v,{children:[t.jsxs(M,{children:[t.jsx(Z,{src:j,alt:"Logo"}),t.jsx(L,{children:"Lorem"})]}),t.jsxs(k,{children:[t.jsx(o,{children:"功能介紹"}),t.jsx(o,{children:"價格方案"}),t.jsx(o,{children:"聯絡我們"}),t.jsx(r,{onClick:s,children:"QrCode"}),t.jsx(r,{onClick:c,children:n==="light"?t.jsx(u,{}):t.jsx(f,{})})]})]})},C=e.div`
  height: 100vh;
  background-color: ${a=>a.theme.background};
  color: ${a=>a.theme.color};
`,$=()=>t.jsxs(C,{children:[t.jsx(y,{}),t.jsx(m,{})]});export{$ as default};
